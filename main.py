...
pdf_path_label = tk.Label(root, text="PDF File:", font=font,bg="darkseagreen")
...
pdf_path_button = tk.Button(root, text="Select File", command=select_file, font=font,bg="lightcyan")
pdf_path_button.grid(row=0, column=2, padx=10, pady=10)

word_path_label = tk.Label(root, text="Word File:", font=font,bg="darkseagreen")
...
convert_button = tk.Button(root, text="Convert to Word", command=convert_pdf_to_word, font=font,bg="peachpuff")
